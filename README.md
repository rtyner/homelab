...
| ---------------- | ----------- | ---------- | ------------ | ----------- | ------------ |
| Physical Disks 1 | 11x 1TB SSD | 1x 1TB SSD | 1x 512GB SSD | 2x 14TB HDD | 2x 10TB HDD  |
| Physical Disks 2 | 5x 2TB HDD  | 2x 2TB HDD |              | 10x 8TB HDD | 2x 8TB HDD   |
| Physical Disks 2 |             | 4x 5TB HDD |              | 3x 1TB SSD  | 1x 250GB SSD |
| Pools            |             |            |              |             |              |
| Shares           |             |            |              |             |              |
...
I run a redundant DNS setup using PowerDNS:

- Primary DNS (dns-prod-01): 10.1.1.96
- Secondary DNS (dns-prod-02): 10.1.1.97
- Zones:
  - local.rtyner.com
  - rtyner.com
...
| --------------------------- | -------------------- | --------------------------------- |
| fw01                        | 10.1.1.1             | primary firewall                  |
...
| nas01                       | 10.1.1.8, 10.20.1.5  | truenas storage server smb, nfs   |
| nas-02                      | 10.1.1.6, 10.20.1.4  | truenas backup server smb, nfs    |
...
| ------------------ | --------------------- | ----------- | --------------------------------------------------- |
| nas-03             | 10.1.1.9              | prod-pve-02 | truenas vm                                          |
...
| prod-haproxy-01    | 10.1.1.30, 10.1.133   | pve-01      | haproxy node 1                                      |
| prod-haproxy-02    | 10.1.1.31, 10.1.1.33  | pve-04      | haproxy node 2                                      |
| nextcloud-prod-01  | 10.1.1.32             | pve-04      | nextcloud                                           |
| arch-dev-02        | 10.1.1.34             | pve-04      | secondary arch server                               |
| k3s-prod-master-01 | 10.1.1.50             | pve-01      | production k3s master                               |
| k3s-prod-master-02 | 10.1.1.51             | pve-02      | production k3s master                               |
| k3s-prod-master-03 | 10.1.1.52             | pve-03      | production k3s master                               |
| k3s-prod-worker-01 | 10.1.1.53             | prod-pve-01 | production k3s worker                               |
| k3s-prod-worker-02 | 10.1.1.54             | prod-pve-01 | production k3s worker                               |
| k3s-prod-worker-03 | 10.1.1.55             | prod-pve-02 | production k3s worker                               |
| k3s-prod-worker-04 | 10.1.1.56             | prod-pve-04 | production k3s worker                               |
| k3s-prod-worker-05 | 10.1.1.57             | prod-pve-04 | production k3s worker                               |
| k3s-prod-worker-06 | 10.1.1.58             | prod-pve-05 | production k3s worker                               |
| k3s-dev-master-01  | 10.1.1.59             | prod-pve-04 | development k3s master                              |
| k3s-dev-worker-01  | 10.1.1.60             | prod-pve-04 | development k3s worker                              |
| k3s-dev-worker-01  | 10.1.1.61             | prod-pve-04 | development k3s worker                              |
| dns-prod-01        | 10.1.1.96             | prod-pve-01 | powerdns master                                     |
| dns-prod-02        | 10.1.1.97             | prod-pve-03 | powerdns slave                                      |
