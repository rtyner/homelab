...
sudo umount ~/mnt/bdp && sudo umount ~/mnt/red && mount ~/mnt/bdp && mount ~/mnt/red
...
# postgres
alias enterdb='sudo -u postgres psql'
alias pgreload='sudo -u postgres psql -c "SELECT pg_reload_conf();"'
alias pgconf='sudo vim /etc/postgresql/17/main/pg_hba.conf'
