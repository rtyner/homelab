...
USER=rt
HOME=/home/${USER}
PUBKEY="ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIITrPYcULQ4WTZs65pFDiSFS1hdsjVRo4DK+02pnRlYc"
...
#bashrc
wget https://raw.githubusercontent.com/rtyner/homelab/main/dotfiles/.bashrc -O ${HOME}/.bashrc
