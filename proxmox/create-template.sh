...
qm set 1000 --scsihw virtio-scsi-pci --scsi0 local:vm-1000-disk-0 --ide2 local:cloudinit,size=32G --boot c --bootdisk scsi0 --serial0 socket --vga serial0 --agent enabled=1
qm template 1000